...
export const seed = () => ({
  ...
  stages: ["Scoping", "Tender ready", "Published on MSTC", "Bids received", "Evaluation", "Awarded"],
  packages: [
    ...
    { id: "C-02", name: "Civil ph.2", stage: "Published on MSTC", est: 40.6, waiting: "Closes 04 Oct" },
    /* EXTRA — wireframe states 2 published, draws 1 */
    { id: "T-118", name: "Instrumentation", stage: "Published on MSTC", est: 12.4, waiting: "Closes 11 Oct", blockedByGate: 3 },
  ...
  pkgMilestones: {
    "M-03": {
      sub: "Piping, estimate Rs 27.8 cr", steps: [
  ...
  tenderCalendar: [
    ...
    { date: "18 Oct", what: "E-02 publication on MSTC" },
  ],
  vendors: [
  ...
  bid: {
    tender: "T-114", bidder: "Shah Constructions", totalFields: 34, page: 12, pages: 86,
  ...
  record: {
    id: "BOQ 2.14", title: "RCC M25 in raft foundation", state: "frozen at contract",
  ...
  notices: [{
    id: "n_seed", ref: "HN-20", iface: "Foundations → mech. erection", owes: "C-01 owes M-02",
...
export const seedFresh = () => ({
  ...
  record: {
    id: "—", title: "No BOQ line selected", state: "not created",
